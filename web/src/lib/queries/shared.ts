...
export const queryKeys = {
  ...
  docSpaces: ["docSpaces"] as const,
  docPages: (spaceId: string) => ["docPages", { spaceId }] as const,
  docPage: (pageId: string) => ["docPage", { pageId }] as const,
  docPageVersions: (pageId: string) => ["docPageVersions", { pageId }] as const,
  docPageVersion: (pageId: string, version: number) =>
    ["docPageVersion", { pageId, version }] as const,
  docPageItems: (pageId: string) => ["docPageItems", { pageId }] as const,
  itemDocs: (itemId: string) => ["itemDocs", { itemId }] as const,
